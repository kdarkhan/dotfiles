...
globalkeys = my_table.join(
    ...
    awful.key({ }, "XF86MonBrightnessUp",
        function ()
            os.execute("/home/monstar/scripts/set_brightness.sh up &> /dev/null")
        end,
        {description = "Increase brightness", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown",
    function ()
        os.execute("/home/monstar/scripts/set_brightness.sh down &> /dev/null")
    end,
    ...
    awful.key({ modkey }, "y", function () awful.spawn("/home/monstar/scripts/hotplug_monitor.sh") end,
              {description = "reconnect screen", group = "launcher"}),
